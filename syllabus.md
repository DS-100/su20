...
- The primary form of support students will have for labs are the **office hours** we’ll host, and **Piazza**.
- We are also experimenting with a **live lab section**, in which GSIs walk through the lab assignment via Zoom. The current plan is to host one of these for each lab assignment (one on Tuesday, one on Thursday); see the [Calendar](../calendar) for when these are scheduled.
...
- There are two “pathways” we envision students taking when it comes to consuming discussion content.
  1. Watching a pre-recorded discussion video, and coming to a discussion recap section.
